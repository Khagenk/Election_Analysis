...
file_to_load = os.path.join("/Users/khagenkadariya/Desktop/election_results.csv")
# Assign a variable to save the file to a path.
file_to_save = os.path.join("/Users/khagenkadariya/Desktop/Election_Analysis /analysis/election_analysis.txt")
